...
| OCR and translation | Text plus QR/common barcode detection, persistent line-break control and Apple Translation | Snapzy, iShot, CleanShot X, Apple Vision | Preserve spatial layout and add an explicit language chooser |
